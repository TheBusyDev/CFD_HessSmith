...
% compute velocity field outside the cylinder
...
for i = 1:Nx
    for j = 1:Ny
        % if the point is located outside the cylinder, compute velocity field
...
% plot velocity field outside the cylinder
[X, Y] = meshgrid (x, y);
