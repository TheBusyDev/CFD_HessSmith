...
[xd, yd, xv, yv, xe, ye] = NACA_4d_a (M, P, SS, N, 'halfcos');
...
% compute velocity field outside the airfoil
...
for i = 1:Nx
    for j = 1:Ny
        % if the point is located outside the airfoil, compute velocity field
...
% plot velocity field outside the airfoil
[X, Y] = meshgrid (x, y);
